...
if (randomNumber == userChoice) {
    alert("Congratulations, you have won! Luck is on your side!");
}
else if (randomNumber == computerChoice) {
    alert("Too bad, the coin sided with the computer this time...");
}
}
else {
...
if (birthYear < 21) {
       alert("We are sorry. You are not old enough for drinking.");
   }
else if (birthYear >= 21) {
       alert("Welcome to AleCool. Please drink responsibly.");
   }
